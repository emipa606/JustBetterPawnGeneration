...
namespace NoMoreRandomSkills
{
    ...
    public static class PawnBioPatch
    {
        ...
        public static void RemoveMissingSkills(this PawnBio pawnBio)
        {
            ...
            {
                pawnBio.childhood.forcedTraits =
                    CleanUpTraitList(pawnBio.childhood.forcedTraits, $"PawnBio: {pawnBio.name.ToStringFull}");
            }

            if (pawnBio.adulthood?.forcedTraits != null)
            {
                pawnBio.adulthood.forcedTraits =
                    CleanUpTraitList(pawnBio.adulthood.forcedTraits, $"PawnBio: {pawnBio.name.ToStringFull}");
            }
        }
